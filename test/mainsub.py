...
class CameraThread(QtCore.QThread):
    ...
    def run(self):
        ...
        model = YOLO('/Users/aaditya/ALSTOM/Lidar/YOLO-Weights/yolov8n.pt')
        ...
        while not self.stop_flag:
            ...
            if ret:
                ...
                cv.putText(frame, str(int(fps)), (10, 30), fontScale=1, fontFace=cv.FONT_HERSHEY_SCRIPT_SIMPLEX, color=(10, 10, 10), thickness=2)  # printing the fps
